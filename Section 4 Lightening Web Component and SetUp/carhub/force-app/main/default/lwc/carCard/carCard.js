...
/** getFieldValue is used to extract field values */
...
export default class CarCard extends NavigationMixin(LightningElement) {
    ...
    // exposing fields to make them available to template
    ...
    handleCarSelected(message){
        console.log('carCard: ',message.carId)
